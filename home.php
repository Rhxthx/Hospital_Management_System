...
<body>
  <div class=" container-fluid bg-info" style="height: 70px">
    <div class="container d-flex align-items-center">
      ...
      <b><h6 class="p-2">Healthwise@gmail.com</h6></b>
    </div>
  </div>
  <nav class="navbar navbar-expand-sm bg-light navbar-light"></nav>
  <div class="container">
    <a href="home.php"><img src="image/hos.png" class="float-start"></a>
    <ul class="nav justify-content-end ">
      ...
      <li class="nav-item">
        ...
        <!-- <div class="dropdown">
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="About.php">About Jaipur Hospital</a></li>
      ...
      <li class="nav-item">
       <a class="nav-link btn btn-info contact-btn mt-2;" href="Book Appointment.php"><h5>Book Appointment</h5></a>
      </li>
      <span class="p-2">
